...
@section('content')
<div>
  <section class="grid grid-cols-1 gap-y-4 place-items-center
  laptop:grid-cols-4 laptop:mx-12 laptop:gap-x-4
  desktop:place-items-stretch">

    <!-- start all projects -->
    <div class="w-fit h-auto bg-white rounded-md border-[#ECEEF6] border-2 p-4
  ...
  <section class="grid grid-cols-1 mx-12 my-6 gap-y-4
  ...
  desktop:grid-cols-2">
    ...
    desktop:w-auto desktop:h-auto">
      ...
      <div class="grid gap-y-6 pb-4">
        ...
        <div class="grid grid-cols-3 items-center gap-x-16">
          <p>{{ $project->p_name }}</p>
