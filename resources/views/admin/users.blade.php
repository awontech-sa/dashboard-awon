        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td>
                    ...
                    <a class="btn btn-sm hidden btn-link bg-[#FAFBFD]" href="{{ route('powers.show') }}"><x-far-pen-to-square class="w-4 h-4 text-gray-600" /></a>
                    @else
                ...
                <td>
                    <a class="btn btn-sm btn-link bg-[#FAFBFD]" href="{{ route('powers.show') }}"><x-far-pen-to-square class="w-4 h-4 text-gray-600" /></a>
                    <a class="btn btn-sm btn-link bg-[#FAFBFD]" href="{{ route('powers.show') }}"><x-far-eye class="w-4 h-4 text-gray-600" /></a>
                    @if($admin->email === $user->email)
                    <a class="btn btn-sm btn-link hidden bg-[#FAFBFD]" href="{{ route('powers.show') }}"><x-far-trash-can class="w-4 h-4 text-red-500" /></a>
                    @else
                    <a class="btn btn-sm btn-link bg-[#FAFBFD]" href="{{ route('powers.show') }}"><x-far-trash-can class="w-4 h-4 text-red-500" /></a>
                    @endif
                </td>
            </tr>
            @endforeach
