...
<div class="grid grid-cols-2 gap-x-[3.3rem] text-base font-normal">
    ...
    <div class="grid gap-y-5">
        ...
        <input disabled class="input text-center text-base" placeholder="{{ $details->framework ?? 'test' }}" type="text" />
    </div>
</div>
...
<div class="grid grid-cols-2 gap-x-[3.3rem] my-8 text-base font-normal">
    <div class="grid gap-y-5">
        ...
        <a class="link" href="{{ $details->github ?? 'test' }}">رابط GiHub</a>
    </div>
    <div class="grid gap-y-5">
        <label>رابط الموقع</label>
        <a class="link" href="{{ $details->link ?? 'test' }}">رابط الموقع</a>
    </div>
</div>
...
<div class="grid grid-cols-2 gap-x-[3.3rem] text-base font-normal">
    <div class="grid gap-y-5">
        ...
        <a class="link" href="{{ $details->ios ?? 'test' }}">رابط التطبيق</a>
    </div>
    <div class="grid gap-y-5">
        <label>رابط التطبيق على Android</label>
        <a class="link" href="{{ $details->android ?? 'test' }}">رابط التطبيق</a>
    </div>
</div>

<div class="grid font-normal text-base my-6 gap-y-5">
    <label for="dashboard">رابط لوحة التحكم</label>
    <a class="link" href="{{ $details->dashboard ?? 'test' }}">رابط لوحة التحكم</a>
</div>