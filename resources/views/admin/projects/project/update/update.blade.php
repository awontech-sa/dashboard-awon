    ...
    <div role="tablist" class="tabs my-11 tabs-boxed bg-transparent">
        ...
        <div role="tabpanel" class="tab-content">
            <div class="my-20">
                ...
                @include('admin.projects.project.update.general-data')
            </div>
        </div>
        ...
        <div role="tabpanel" class="tab-content">
            <div class="my-20">
                @include('admin.projects.project.update.attachments')
            </div>
        </div>
        ...
        <div role="tabpanel" class="tab-content">
            <div class="my-20">
                ...
                <form action="{{ route('admin.update.project', ['step' => $step, 'id' => $project->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @include('admin.projects.project.update.status')
        ...
        <div role="tabpanel" class="tab-content">
            <div class="my-20">
                ...
                <form action="{{ route('admin.update.project', ['step' => $step, 'id' => $project->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @include('admin.projects.project.update.level')
        ...
        <div role="tabpanel" class="tab-content">
            <div class="my-20">
                ...
                <form action="{{ route('admin.update.project', ['step' => $step, 'id' => $project->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @include('admin.projects.project.update.code')
        ...
        <div role="tabpanel" class="tab-content">
            <div class="my-20">
                ...
                <form action="{{ route('admin.update.project', ['step' => $step, 'id' => $project->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @include('admin.projects.project.update.team', ['users' => $users])
