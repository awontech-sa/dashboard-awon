...
<div class="grid grid-cols-2 gap-x-[3.3rem] my-8">
    <div class="grid gap-y-5">
        ...
        <input id="project-duration" name="project-duration" class="input text-center text-base input-disabled" type="text" placeholder="" />
    </div>
    <div class="grid gap-y-5">
        <label for="remaining-duration">المدة المتبقية</label>
        <input id="remaining-duration" name="project-remaining" class="input text-center text-base input-disabled" type="text" placeholder="" />
    </div>
</div>
...
<div class="grid font-normal text-base my-6 gap-y-5">
    ...
    <textarea name="project-desription" class="textarea textarea-lg"></textarea>
</div>
